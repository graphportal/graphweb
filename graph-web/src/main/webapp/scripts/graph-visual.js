var graphVisApp = angular.module('graphVisApp', [ 'ngRoute', 'ngSanitize', 'ngAnimate', 'ui.bootstrap']);
...
graphVisApp.controller('GraphVisCtrl', function GraphVisCtrl ($scope, $location, graphDataFactory, $http, $filter) {

	var docEl = document.documentElement
	var width = window.innerWidth || docEl.clientWidth,
    	height =  window.innerHeight|| docEl.clientHeight;
	
	height = Math.round(height - height * 0.35);
...
GraphCreator.prototype.svgMouseUp = function() {
    ...
    if (state.justScaleTransGraph) {
      ...
      var xycoords = d3.mouse(thisGraph.svgG.node()),
          d = {id: thisGraph.idct++, title: "[Shft-click to enter node name]", x: xycoords[0], y: xycoords[1]};
...
GraphCreator.prototype.getNodes = function() {
    return this.nodes;
};
GraphCreator.prototype.setNodes = function(nodes) {
    this.nodes = nodes;
};

GraphCreator.prototype.getEdges = function() {
    return this.edges;
};
GraphCreator.prototype.setEdges = function(edges) {
    this.edges = edges;
};
